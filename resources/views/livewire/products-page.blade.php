    ...
    <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
      <div class="flex flex-wrap mb-24 -mx-3">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">LKR 1000</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">LKR 500000</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="w-full px-3 lg:w-3/4">
          ...
          <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3 cursor-default" wire:key{{$product->id}}>
            <div class="border border-gray-300 dark:border-gray-700 cursor-default">
            <div class="relative bg-gray-200 cursor-default">
              <p href="/product/{{$product->slug}}">
              <img src="{{ asset('storage/' . $product->image[0]) }}" alt="{{ $product->name }}"
                class="object-cover w-full h-56 mx-auto cursor-default">
              </>
            </div>
            <div class="p-3">
              ...
              <p class="text-lg">
              <span class="text-green-600 dark:text-green-600">LKR {{ number_format($product->price, 2) }}</span>
              </p>
            </div>
