        ...
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    ...
                    <div class="space-y-3">
                        <p class="text-sm text-gray-600">If you need to make changes to your order, you can cancel it and place a new one.</p>
                        
                        <form action="{{ route('orders.cancel', $order->id) }}" method="POST" class="mt-3">
                            @csrf
                            @method('PATCH')
                            <button type="submit" onclick="return confirm('Are you sure you want to cancel this order?')" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                ...
                <div class="bg-red-50 rounded-xl shadow-sm p-6 border border-red-100">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-lg font-medium text-red-800">This order has been cancelled</h2>
                    </div>
                    <p class="mt-2 text-sm text-red-700">If you still need the products, please place a new order.</p>
                </div>
                @endif
            </div>
